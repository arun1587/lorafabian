...
const uint8_t HARDCODED_MAC[] = {0xfa,0xb0,0x00,0x00,0x00,0x00,0x00,0x01};
// testing kappa node
//const uint8_t HARDCODED_MAC[] = {0xfa,0xb0,0x00,0x00,0x00,0x00,0x00,0x0a};
...
is_my_mac(frame802154_lora_t *frame)
{
  ...
  if(frame->fcf._10_11_dst_addr_mode == ADDRESS_0b_LENGTH) return 0;
